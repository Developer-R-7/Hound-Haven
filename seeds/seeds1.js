...
const newUser1 = async () => {
    ...
    let pet = {};
		...
		pet.img = "https://i.pinimg.com/originals/60/3a/e8/603ae8ce7f600eb1f32631509c6b5a76.jpg";
		pet.gender = "male";
		pet.type = "Bunny";
...
const newUser2 = async() => {
    ...
    let pet = {};
		...
		pet.img = "https://static.wikia.nocookie.net/secretlifeofpets/images/b/b8/Gidget_pomeranian.png/revision/latest/scale-to-width-down/620?cb=20160903095324";
		pet.gender = "female";
		pet.type = "Dog";
...
const newUser3 = async() => {
    ...
    let pet = {};
		...
		pet.img = "https://static.wikia.nocookie.net/secretlifeofpets/images/f/f2/Chloe.png/revision/latest/scale-to-width-down/620?cb=20160614111511";
		pet.gender = "female";
		pet.type = "cat";
   ...
   let pet2 = {};
		...
		pet2.img = "https://static.wikia.nocookie.net/secretlifeofpets/images/2/2e/Norman.png/revision/latest/scale-to-width-down/619?cb=20160614145354";
		pet2.gender = "male";
